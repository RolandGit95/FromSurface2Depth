...
def getParentFolder(depth):
    path = os.getcwd()
    for _ in range(depth):
        path = os.path.dirname(path)
    return path

working_path = os.path.join(getParentFolder(2), 'src/')
...
# %%
dataset = TestDataset('/home/roland/Projekte/FromSurface2Depth/data/processed/regimeB/X_test.npy',
                     '/home/roland/Projekte/FromSurface2Depth/data/processed/regimeB/Y_test.npy')
...
# %%
suffixes = [f"t{sfx}_d0-32,1" for sfx in ["32"]]
